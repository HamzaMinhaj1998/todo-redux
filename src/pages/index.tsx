...
const Page = () => {
  ...
  const editButton = (item: string) => {
    console.log(setTodoUpdate(item));
    setUpdatedTodo(true);
  };
        ...
        <div className="header flex justify-center items-center w-full">
          <div className="flex flex-col">
            <input
              ...
              name="title"
              className="border-2 rounded-l-lg p-1"
            />
          </div>
          <button
            onClick={addTitle}
            className="bg-[lightGray] rounded-r-lg p-[6px]"
          >
            Add Task
          </button>
        </div>
              ...
              <div key={index}>
                {updatedTodo ? (
                  <div>
                    ...
                    />
                    <button
                      onClick={() => setUpdatedTodo(!updatedTodo)}
                      className="bg-[lightGray] rounded-r-lg p-[6px]"
                    >
                      Update Task
                    </button>
                  ...
                  <li className="flex justify-between mb-3">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <button
                        className="bg-white rounded-md font-medium text-sm p-1 w-14"
                        onClick={() => {
                          editButton(item);
                        }}
                      >
                      ...
                      <button
                        onClick={() => deletedTitle(item)}
                        className="bg-white rounded-md text-sm p-1 w-14 font-medium"
                      >
                        Delete
                      </button>
                    </div>
